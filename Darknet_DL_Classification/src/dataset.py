...
from src.utils.cat_ipinform import CatIPInformation
...
class Darknet:
    ...
    # create function to export processed dataset
    ...
    def getTrainTestValData(self, size_test: float, job: bool) -> pd.DataFrame:
        ...
        # split data with sklearn's built in function 
    ...
    #  create a function to get normalization layer using Normalization function from tensorflow
    ...
    # create a function to encode integer values 
    ...
    # create a funtion to get processed data
...
class DarknetDataProcessing:
    ...
    # create a function to start preprocessing
    def doPreProcessing(self):
        # Correction of lables

        samples = self.data.copy()

        # create variables to hold unique values from target columns
        ...
        # labeling the target column into benign or darknet
        ...
        # create a tuple which contains SRC&DST IP
        ...
        # create country and bogon (simply fake IP address) column
        ...
        # find columns contains nan values
        ...
        # create arrays which hold the column names to encode 
        ...
        # print the total nan value
        print(samples[samples.columns[samples.isna().sum() > 0]].isna().sum())

    # create a function to get processed data
